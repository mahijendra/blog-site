        ...
        <>
            ...
            {/!*<div className="container_slug ">
                ...
                <div className="post-content-wrap">
                    ...
                    <h1 className="singlePost_title">{title}</h1>
                    <hr className="post-content-wrap_hr"></hr>
                        <div className="header__content_slug">
                            <div className="header__section">
                                <ul className="header__ul">
                                    <Link href="https://github.com/mahijendra">
                                        <li>
                                            <FaGithub className="headerIcon" />
                                        </li>
                                    </Link>
                                    <li>
                                        <Link href="https://twitter.com/BMahijendra"><FaTwitter className="headerIcon" /></Link>
                                    </li>
                                    <li>
                                        <Link href="https://www.linkedin.com/in/mahijendra-b-v-k-432ba215b/"><FaLinkedin className="headerIcon" /></Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    <hr className="post-content-wrap_hr"></hr>
                    <div className="blockContent_body">
                                ...
                                <li key={person.name} className="sm:py-8">
                                    <div className="flex justify-center alignCenter gap-x-4 gap-y-4">
                                        <div className="aspect-w-3 aspect-h-2 sm:aspect-w-3 sm:aspect-h-4 flex justify-center ">
                                            <img className="object-cover shadow-lg rounded-full w-32 h-32 xl:w-32 xl:h-32" src={person.imageUrl} />
                                        </div>
